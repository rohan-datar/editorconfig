...
#+begin_src emacs-lisp
    (use-package general
     ...
     (defun rdmacs/smart-recompile ()
       "Run `projectile-recompile' if in a project, otherwise `recompile'."
       (interactive)
       (if (projectile-project-p)
           (call-interactively #'projectile-recompile)
         (call-interactively #'recompile)))

     (rdmacs/leader-keys
      "c" '(:ignore t :wk "Compile & AI")
      "c c" '(rdmacs/smart-compile :wk "Run compile command")
      "c r" '(rdmacs/smart-recompile :wk "Recompile")
