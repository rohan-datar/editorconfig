...
#+begin_src emacs-lisp
    (use-package projectile
      ...
      (projectile-project-search-path '("~/Documents/" "~/Documents/UW-Classes/" "~/Documents/dev/" "~/nix" ("~/editorconfig" . 1)))) ;; . 1 means only search the first subdirectory level for projects
#+end_src
