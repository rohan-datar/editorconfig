...
- [[#ai][AI]]
  ...
  - [[#ai-code-interface][AI Code Interface]]
- [[#org-mode][Org Mode]]
...
#+begin_src emacs-lisp
    (let ((cache-dir (expand-file-name "~/.cache/emacs/")))
      ...
      ;;  history
      (setq -save-file (expand-file-name "-save.el" cache-dir)))
...
#+begin_src emacs-lisp
    (use-package ai-code
      ...
      (setq ai-code-backends-infra-terminal-backend (if (eq system-type 'darwin) 'vterm 'ghostel))
