...
#+begin_src emacs-lisp
    (use-package general
      ...
      (rdmacs/leader-keys
    	"a" '(:ignore t :wk "AI")
    	"a s" '(agent-shell :wk "Toggle agent-shell")
    	"a c" '(copilot-chat :wk "Copilot Chat")
    	"a v" '(agent-shell-other-buffer :wk "Agent shell toggle viewport")
    	"a n" '(agent-shell-new-shell :wk "Start new agent-shell")
    	)
...
#+begin_src emacs-lisp
    (use-package claude-code
      :config
      (setq claude-code-terminal-backend 'vterm) ;;TODO: switch this to ghostel once it's in nixpkgs
      (claude-code-mode)
