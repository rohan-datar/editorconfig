...
#+begin_src emacs-lisp
        (use-package emacs
          ...
          ;; menu-bar-mode, scroll-bar-mode, tool-bar-mode moved to early-init.el
...
#+begin_src emacs-lisp
    (use-package evil
      ...
      ;; move text up/down
      (evil-define-key 'visual 'global (kbd "K") 'move-text-up)
      (evil-define-key 'visual 'global (kbd "J") 'move-text-down)
...
* Appearance
** Theme
Theme loading moved to =early-init.el= to avoid flash of default colors on startup.
...
** Move Text
Move regions of text up/down as a group
#+begin_src emacs-lisp
    (use-package move-text
      :after evil
      :config
      (defun rdmacs/indent-region-advice (&rest ignored)
      ...
      (advice-add 'move-text-up :after 'rdmacs/indent-region-advice)
      (advice-add 'move-text-down :after 'rdmacs/indent-region-advice))
#+end_src
